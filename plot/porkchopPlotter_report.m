function porkchopPlotter_report(dvData, stepF, selectedIndex,legNum, dvNum)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% porkchopPlotter_report - Generate zoomed and simplified porkchop plots
% for report
%
%   This function creates a zoomed and simplified porkchop plot intended
%   for report presentations. It uses a refined grid to display delta-v
%   contours and highlights the advised launch date.
%
%   Inputs:
...
%       selectedIndex- Array of indices specifying the advised launch
%                      date for highlighting.
...
%       the simplified porkchop plot for the report.)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    h6 = scatter(date1_VI, date2_VI, 30^2, 'p', 'MarkerEdgeColor','k',...
        'MarkerFaceColor','k','MarkerFaceAlpha', 1);
    ...
    % % Legend
    % % =====================================================================
    lgd = legend(h6, {'Launch date'}, 'Location', 'NorthWest');
    set(lgd, 'FontSize', 34);
   
    % Find the line objects within the legend and adjust their properties
    legendLines = findobj(lgd, 'Type', 'line');
    set(legendLines, 'MarkerSize', 10, 'LineWidth', 2);
